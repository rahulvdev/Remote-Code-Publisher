...
//Description:
//------------------------
//This file provides templates for the NoSql database and associated elements.
...
//Updates the value of a child corresponding to 
//a particular element
template<typename Data>
void NoSqlDb<Data>::updateChildVal(Key key,std::vector<std::string> vect) {
	bool flag = false;
...
//Writes Database content to an XML file
template<typename Data>
...
//Reads an XML file for database population
template<typename Data>
...
//Used to set path for XML file generation
template<typename Data>
...
//Used to insert a child value into an element
template<typename Data>
